...
int main(void)
{
    ...
    while (1)
    {
    	...
    	ADC_value2 = ADC_GetInjectedConversionValue(ADC1, ADC_InjectedChannel_3);
    	ADC_value3 = ADC_GetInjectedConversionValue(ADC1, ADC_InjectedChannel_4);

    	sprintf(buffer, "%d : %d : %d : %d\r\n", ADC_value0, ADC_value1, ADC_value2, ADC_value3);
   		USARTSend(buffer);
    }
}

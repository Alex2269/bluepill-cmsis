...
volatile uint16_t ADCBuffer[] = {0x0000, 0x0000 ,0x0000};
...
void ADC_DMA_Init(void)
{
	...
	//ADC now Start manually in TIM1_UP_IRQHandler
}
//=================================================================================

uint16_t ADC_DMA_GET(uint8_t ADC_DMA_n) {
	if (ADC_DMA_n < sizeof((ADCBuffer))) {
	  return ADCBuffer[ADC_DMA_n];
	}
	else {
		return 0;
	}
